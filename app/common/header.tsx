        ...
        <div className="hidden md:flex items-center">
          <div className="ml-7 flex gap-4 items-center">
            ...
            <h1>
              <a
                href="/register"
                className="cursor-pointer text-black bg-violet-400 px-6 py-2 rounded-xl shadow-md hover:bg-violet-800 hover:text-white transition-all duration-200"
              >
                Sign Up
              </a>
            </h1>
      ...
      >
        <nav className="py-4 text-black">
          ...
          <div className="mt-4 px-4 flex flex-col gap-4">
            <a
              href="/login"
              className="text-center hover:text-violet-400 transition-colors duration-200"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Login
            </a>
            <a
              href="/register"
              className="text-center text-black bg-violet-400 px-6 py-2 rounded-xl shadow-md hover:bg-violet-800 hover:text-white transition-all duration-200"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Sign Up
            </a>
