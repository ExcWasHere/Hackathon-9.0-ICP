...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-violet-900 py-8 md:py-12 text-white">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="hidden md:flex flex-col lg:flex-row items-start justify-between">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <Link to="/our-story" className="hover:text-violet-200 transition-colors">
                Our Story
              </Link>
            ...
            <div className="flex flex-col space-y-3">
              ...
              <Link to="/faq" className="hover:text-violet-200 transition-colors">
                FAQ
              </Link>
              <Link to="/contact" className="hover:text-violet-200 transition-colors">
                Contact Us
              </Link>
              <Link to="/help" className="hover:text-violet-200 transition-colors">
                Help Center
              </Link>
            </div>
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <div className="flex flex-col space-y-2">
                  <Link to="/our-story" className="hover:text-violet-200">
                    Our Story
                  </Link>
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-col space-y-2">
                  <Link to="/faq" className="hover:text-violet-200">
                    FAQ
                  </Link>
                  <Link to="/contact" className="hover:text-violet-200">
                    Contact Us
                  </Link>
                  <Link to="/help" className="hover:text-violet-200">
                    Help Center
                  </Link>
                </div>
              </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/20">
          <div className="flex flex-wrap justify-center md:justify-start gap-4 text-sm text-white/80">
            <Link to="/privacy" className="hover:text-violet-200">
              Privacy Policy
            </Link>
            <span className="hidden md:block">|</span>
            <Link to="/terms" className="hover:text-violet-200">
              Terms of Service
            </Link>
            <span className="hidden md:block">|</span>
            <Link to="/cookies" className="hover:text-violet-200">
              Cookie Policy
            </Link>
          </div>
        </div>
